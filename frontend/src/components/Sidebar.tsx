      ...
      <div className="sidebar-nav">
        <button
          ...
          className={`sidebar-btn${
            fantasy && pathname === '/dashboard' ? ' is-active' : ''
          }`}
        ...
        <button
          type="button"
          className={`sidebar-btn${
            fantasy && pathname === '/profile' ? ' is-active' : ''
          }`}
        ...
        <button
          type="button"
          className={`sidebar-btn${
            fantasy && pathname === '/create-room' ? ' is-active' : ''
          }`}
          aria-current={pathname === '/create-room' ? 'page' : undefined}
          onClick={() => go('/create-room')}
        >
        ...
        <button
          type="button"
          className={`sidebar-btn${
            fantasy && pathname === '/settings' ? ' is-active' : ''
          }`}
